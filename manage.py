...
def deploy():
    ...
    course3 = Course(course_number='ACCT 327', title='Cost Accounting', description='Process, job order and standard costing; variable and absorption costing; budgeting, decentralization, and transfer pricing; and cost analysis for managerial applications.')
